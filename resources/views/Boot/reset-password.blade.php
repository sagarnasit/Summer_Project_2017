...
<!-- Mirrored from demo.enpek.com/html-templates/boot/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:57 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--=================== The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags ===================-->
    <meta name="description" content="Reset-Password-Boot Responsive HTML Template">
    <meta name="author" content="Reset-Password-Boot Responsive HTML Template">
    <link rel="shortcut icon" href="assets/images/themetidy-shopify-paira-theme-framework-favicon-boot.png" type="image/png" />
    <title>Reset-Password-Boot Responsive HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
