...
<!-- Mirrored from demo.enpek.com/html-templates/boot/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:51 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--=================== The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags ===================-->
    <meta name="description" content="Blog-Boot Responsive HTML Template">
    <meta name="author" content="Blog-Boot Responsive HTML Template">
    <link rel="shortcut icon" href="assets/images/themetidy-shopify-paira-theme-framework-favicon-boot.png" type="image/png" />
    <title>Blog-Boot Responsive HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
...
<div class="paira-container">
    ...
    <main class="blog-page">
        ...
        <section class="blog-content paira-animation-container margin-bottom-75">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 paira-animation" data-paira-animation="fadeInLeft" data-paira-animation-delay="0.3s">
                        <div class="paira-product product position text-center">
                            <div class="position">
                                <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-1.jpg" alt="" class="paira-product-image img-responsive blog-img"></a>
                            </div>
                        </div>
                        <div class="blog-back-or position margin-bottom-40">
                            ...
                            <p><span class="font-color-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo con...</span></p>
                            <a class="btn btn-success text-uppercase color-scheme-4 letter-spacing-2 padding-right-30 padding-left-30 font-size-16">Read more</a>
                        </div>
                        <div class="paira-product product position text-center">
                            <div class="position">
                                <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-3.jpg" alt="" class="paira-product-image img-responsive blog-img"></a>
                            </div>
                        </div>
                        <div class="blog-back-or position margin-bottom-60">
                            <h3 class="text-uppercase"><a href="#" class="font-color-white">All Men choosen converse shoe</a></h3>
                            <ul class="list-inline margin-bottom-0 font-size-16 font-bold">
                                <li><p>7 Comments</p></li>
                                <li><p>/</p></li>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 paira-animation" data-paira-animation="fadeInRight" data-paira-animation-delay="0.3s">
                        <div class="paira-product product position text-center pro-1">
                            <div class="position">
                                <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-2.jpg" alt="" class="paira-product-image img-responsive blog-img"></a>
                            </div>
                        </div>
                        <div class="blog-back-or position margin-bottom-40">
                            <h3 class="text-uppercase"><a href="#" class="font-color-white">All Men choosen converse shoe</a></h3>
                        ...
                        <div class="paira-product product position text-center">
                            <div class="position">
                                <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-4.jpg" alt="" class="paira-product-image img-responsive blog-img"></a>
                            </div>
                        </div>
                        <div class="blog-back-or position margin-bottom-60">
                            <h3 class="text-uppercase"><a href="#" class="font-color-white">All Men choosen converse shoe</a></h3>
                    ...
                    <div class="page-header text-center">
                        <h1 class="text-uppercase">Recent post</h1>
                        <hr>
                    </div>
...
<!-- Mirrored from demo.enpek.com/html-templates/boot/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:55 GMT -->
</html>
