...
<!-- Mirrored from demo.enpek.com/html-templates/boot/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:39 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--=================== The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags ===================-->
    <meta name="description" content="Login-Boot Responsive HTML Template">
    <meta name="author" content="Login-Boot Responsive HTML Template">
    <link rel="shortcut icon" href="assets/images/themetidy-shopify-paira-theme-framework-favicon-boot.png" type="image/png" />
    <title>Login-Boot Responsive HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
                    ...
                    <div class="log-form">
                        <form accept-charset="UTF-8" action="#" class="contact-form" method="post">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control margin-bottom-40" name="contact[email]" placeholder="Email">
                                <label><i class="fa fa-lock"></i></label>
                                <input type="email" class="form-control margin-bottom-40" name="contact[password]" placeholder="Password">
                            </div>
                            <a href="register.html" class="btn btn-default text-uppercase font-bold pull-left margin-left-15 margin-bottom-75 btn-lg">login</a>
                            <a href="reset-password.html" class="text-uppercase pull-right margin-bottom-75 reset-bt margin-right-15 margin-top-20 font-bold font-color-orange fg-pass">Forget Password<i class="fa fa-long-arrow-right margin-left-10"></i></a>
                        </form>
                    </div>
                </div>
                <div class="row small-foot margin-bottom-75">
                    <a href="#" class="text-uppercase pull-left reset-bt margin-top-15 margin-left-15 font-bold margin-top-20">new customer<i class="fa fa-long-arrow-right margin-left-10"></i></a>
                    <a href="#" class="btn btn-success text-uppercase padding-left-45 font-bold padding-right-45 pull-right margin-right-15 btn-lg">Create account</a>
                </div>
            </div>
        </section>
    </main>
