...
<!-- Mirrored from demo.enpek.com/html-templates/boot/category.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:57 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--=================== The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags ===================-->
    <meta name="description" content="Category-Boot Responsive HTML Template">
    <meta name="author" content="Category-Boot Responsive HTML Template">
    <link rel="shortcut icon" href="assets/images/themetidy-shopify-paira-theme-framework-favicon-boot.png" type="image/png" />
    <title>Category-Boot Responsive HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
...
<div class="paira-container">
    ...
    <main class="page-category">
        ...
        <section class="category text-center margin-bottom-75 paira-animation-container padding-top-45">
            <div class="container">
                <div class="row margin-top-30">
                    <div class="col-md-6 col-sm-6 col-xs-6 paira-animation" data-paira-animation="fadeInLeft" data-paira-animation-delay="0.3s">
                        <div class="paira-product product position category-content margin-bottom-40">
                            <div class="col-md-8">
                                <div class="position">
                        ...
                        <div class="paira-product product position category-content margin-bottom-40">
                            <div class="col-md-8">
                                <div class="position">
                                    <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-3.jpg" alt="" class="paira-product-image img-responsive"></a>
                                </div>
                                <div class="product-hover text-uppercase">
                                    <a href="collection.html" class="btn btn-success text-uppercase position">Shop The collection</a>
                                </div>
                        ...
                        <div class="paira-product product position category-content margin-bottom-40">
                            <div class="col-md-8">
                                <div class="position">
                                    <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-5.jpg" alt="" class="paira-product-image img-responsive"></a>
                                </div>
                                <div class="product-hover text-uppercase">
                                    <a href="collection.html" class="btn btn-success text-uppercase position">Shop The collection</a>
                                </div>
                        ...
                        <div class="paira-product product position category-content">
                            <div class="col-md-8 last-category-content1">
                                <div class="position">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 paira-animation" data-paira-animation="fadeInRight" data-paira-animation-delay="0.3s">
                        <div class="position paira-product product category-content1 margin-bottom-40">
                        ...
                        <div class="position paira-product product category-content1 margin-bottom-40">
                            ...
                            <div class="col-md-8">
                                <div class="position">
                                    <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-4.jpg" alt="" class="paira-product-image img-responsive"></a>
                                </div>
                                <div class="product-hover text-uppercase">
                                    <a href="collection.html" class="btn btn-success text-uppercase position">Shop The collection</a>
                                </div>
                        ...
                        <div class="position paira-product product category-content1 margin-bottom-40">
                            <div class="col-md-4 background-or1">
                                <h4 class="text-uppercase font-bold font-color-white padding-top-45">Concerese</h4>
                                <h1 class="font-bold">9</h1>
                                <h4 class="text-uppercase">Products</h4>
                            </div>
                            <div class="col-md-8">
                                <div class="position">
                                    <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-6.jpg" alt="" class="paira-product-image img-responsive"></a>
                                </div>
                                <div class="product-hover text-uppercase">
                                    <a href="collection.html" class="btn btn-success text-uppercase position">Shop The collection</a>
                                </div>
                        ...
                        <div class="position paira-product product category-content1">
                            <div class="col-md-4 background-or1">
                                <h4 class="text-uppercase font-bold font-color-white padding-top-45">Concerese</h4>
                                <h1 class="font-bold">15</h1>
                                <h4 class="text-uppercase">Products</h4>
                            </div>
                            <div class="col-md-8">
                                <div class="position">
                                    <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-8.jpg" alt="" class="paira-product-image img-responsive"></a>
                                </div>
                                <div class="product-hover text-uppercase">
                                    <a href="collection.html" class="btn btn-success text-uppercase position">Shop The collection</a>
                                </div>
...
<!-- Mirrored from demo.enpek.com/html-templates/boot/category.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:30:00 GMT -->
</html>