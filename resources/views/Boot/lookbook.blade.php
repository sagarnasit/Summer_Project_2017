...
<!-- Mirrored from demo.enpek.com/html-templates/boot/lookbook.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:45 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--=================== The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags ===================-->
    <meta name="description" content="Look-Book-Boot Responsive HTML Template">
    <meta name="author" content="Look-Book-Boot Responsive HTML Template">
    <link rel="shortcut icon" href="assets/images/themetidy-shopify-paira-theme-framework-favicon-boot.png" type="image/png" />
    <title>Look-Book-Boot Responsive HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
...
<div class="paira-container">
    ...
    <main class="lookbook-page">
        ...
        <section class="lookbook-content paira-animation-container margin-bottom-75 paira-animation-container">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-header text-center">
                            <h1 class="text-uppercase">Look Book</h1>
                            <hr class="margin-bottom-60">
                        </div>
                    </div>
                    <div class="margin-top-20">
                        <div class="col-lg-3 col-md-3 col-xs-3 paira-animation" data-paira-animation="fadeInLeft" data-paira-animation-delay="0.2s">
                            <h2 class="text-uppercase font-bold padding-left-30">Walk<br><span class="font-color-orange">Shoe </span>for <br> all <span class="font-color-orange">woman</span></h2>
                            <a class="text-uppercase font-bold font-size-16 padding-left-30" href="#">Shop now</a>
                            <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-7.jpg" alt="" class="paira-product-image img-responsive"></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6">
                            <div class="row special-product-hover">
                                <div class="paira-special-product position">
                                    <div class="paira-product product">
                                        <a href="#"><img src="assets/images/category/themetidy-paira-framework-boot-responsive-html-template-category-9.jpg" alt="" class="paira-product-image img-responsive"></a>
                                    </div>
                                    <div class="paira-product product">
                        ...
                        <div class="col-lg-3 col-md-3 col-xs-3 padding-bottom-20 paira-animation" data-paira-animation="fadeInRight" data-paira-animation-delay="0.2s">
                            <a href="#"><img src="assets/images/product/themetidy-paira-framework-boot-responsive-html-template-product-3.jpg" alt="" class="paira-product-image img-responsive"></a>
                            <h2 class="text-uppercase font-bold padding-left-30 margin-top-0">Walk<br><span class="font-color-orange">Shoe </span>for <br> all <span class="font-color-orange">woman</span></h2>
                            <a class="text-uppercase font-bold font-size-16 padding-left-30" href="#">Shop now</a>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from demo.enpek.com/html-templates/boot/lookbook.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:51 GMT -->
</html>
