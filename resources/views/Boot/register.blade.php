...
<!-- Mirrored from demo.enpek.com/html-templates/boot/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:39 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--=================== The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags ===================-->
    <meta name="description" content="Register-Boot Responsive HTML Template">
    <meta name="author" content="Register-Boot Responsive HTML Template">
    <link rel="shortcut icon" href="assets/images/themetidy-shopify-paira-theme-framework-favicon-boot.png" type="image/png" />
    <title>Register-Boot Responsive HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
                    ...
                    <div>
                        <form accept-charset="UTF-8" action="#" class="contact-form" method="post">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control margin-bottom-40" name="contact[name]" placeholder="First Name">
                                <label><i class="fa fa-user"></i></label>
                                <input type="email" class="form-control margin-bottom-40" name="contact[name]" placeholder="Last Name">
                            ...
                            <a href="#" class="btn btn-default text-uppercase font-bold  pull-left margin-left-15 btn-lg color-scheme-1 btn-sub paira-animation" data-paira-animation="fadeInUp" data-paira-animation-delay="0.2s">Submit</a>
