...
<!-- Mirrored from demo.enpek.com/html-templates/boot/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:55 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--=================== The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags ===================-->
    <meta name="description" content="Blog-Post-Boot Responsive HTML Templatrk">
    <meta name="author" content="Blog-Post-Boot Responsive HTML Templat">
    <link rel="shortcut icon" href="assets/images/themetidy-shopify-paira-theme-framework-favicon-boot.png" type="image/png" />
    <title>Blog-Post-Boot Responsive HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
...
<div class="paira-container">
    ...
    <main class="blog-single-page">
        ...
        <section class="blog-single-content blog-content margin-bottom-75 paira-animation-container">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-header text-center">
                            <h1 class="text-uppercase">Boot blog</h1>
                            <hr>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-40 paira-animation" data-paira-animation="fadeInLeft" data-paira-animation-delay="0.3s">
                        <div class="paira-product product position text-center">
                            <div class="position">
                        ...
                        <div class="blog-back-or position margin-bottom-40">
                            <h3 class="text-uppercase"><a href="#" class="font-color-white">All Men choosen converse shoe</a></h3>
                            <ul class="list-inline margin-bottom-0 font-size-16 font-bold">
                                <li><p>7 Comments</p></li>
                                <li><p>/</p></li>
                                <li><p>24 Oct , 2015 by Theme Tidy</p></li>
                            </ul>
                            <p><span class="font-color-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo con...
                            </span></p>
                            <div class="margin-bottom-30 margin-top-10 post-pre-next">
                                <a href="#" class="margin-bottom-10  pull-left font-bold"><i class="fa fa-long-arrow-left margin-right-5 font-color-white"></i>Older Post</a>
                                <a href="#" class="margin-bottom-10 pull-right font-bold">Newer Post<i class="fa fa-long-arrow-right margin-left-5 font-color-white"></i></a>
                            </div>
                        </div>
                        <div class="blog-post-comments margin-top-50">
                            <h3 class="margin-clear">Comments</h3>
                            <ul class="list-unstyled">
                                <li class="margin-bottom-60 margin-top-40">
                                    <img class="img-responsive pull-left margin-right-15" src="assets/images/themetidy-paira-framework-fancy-responsive-html-template-single-blog-user.jpg">
                                    <div class="comments-content padding-top-5">
                                        <h5 class="font-bold">Themetidy</h5>
                                        <h6 class="font-bold">January 14, 2015</h6>
                                        <p class="margin-top-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercit</p>
                                    </div>
                                </li>
                                <li class="margin-bottom-60">
                                    <img class="img-responsive pull-left" src="assets/images/themetidy-paira-framework-fancy-responsive-html-template-single-blog-user.jpg">
                                    <div class="comments-content padding-top-5">
                                        <h5 class="font-bold">Themetidy</h5>
                                        <h6 class="font-bold">January 14, 2015</h6>
                                        <p class="margin-top-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercit</p>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="text-justify">
                            <form accept-charset="UTF-8" action="#" class="contact-form" method="post">
                                ...
                                <button type="submit" class="btn btn-default btn-lg text-uppercase" value="Send">Submit Comment</button>
                            </form>
                        </div>
                    </div>
                    <div class="margin-top-20 recent-posts">
                        <div class="col-lg-12">
                            <div class="page-header text-center">
                                <h1 class="text-uppercase">Recent posts</h1>
                                <hr>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <h4 class="text-uppercase"><a href="#" class="font-bold">All Men choosen converse shoe</a></h4>
                            <p><span>Lorem ipsum dolor sit  dolore magna aliqua. ullamco laboris nisi ut aliquip ex ea commodo con...</span></p>
                            <ul class="list-inline margin-bottom-0 font-bold">
                                <li><p>7 Comments</p></li>
                                <li><p>/</p></li>
                                <li><p>24 Oct , 2015 by Theme Tidy</p></li>
                            </ul>
...
<script>(function(d, s, id) {
    ...
    js.src = "../../../connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.3&appId=1448224865456778";
    fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>
</body>

<!-- Mirrored from demo.enpek.com/html-templates/boot/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:57 GMT -->
</html>
