...
<!-- Mirrored from demo.enpek.com/html-templates/boot/search.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2017 14:29:55 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--=================== The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags ===================-->
    <meta name="description" content="Search-Boot Responsive HTML Template">
    <meta name="author" content="Search-Boot Responsive HTML Template">
    <link rel="shortcut icon" href="assets/images/themetidy-shopify-paira-theme-framework-favicon-boot.png" type="image/png" />
    <title>Search-Boot Responsive HTML Template</title>
    <!--=================== Bootstrap core CSS ===================-->
...
<div class="paira-container">
    ...
    <main class="search-page">
        ...
        <section class="content-search margin-bottom-75 paira-animation-container">
            <div class="container">
                <div class="row">
                    ...
                    <div>
                        <div>
                            ...
                            <input type="text" class=" form-control margin-bottom-20" name="contact[name]" placeholder="Search Here.....">
                        </div>
                    </div>
                    <div class="text-center">
                        <a class="btn btn-default btn-lg text-uppercase margin-top-20 color-scheme-1 btn-sub" href="index-2.html"><strong>Go now</strong></a>
                    </div>
                </div>
            </div>
        </section>
...
<script src="assets/js/jquery.elevateZoom-3.0.8.min.html"></script>
