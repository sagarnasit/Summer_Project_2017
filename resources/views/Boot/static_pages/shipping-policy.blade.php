	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center margin-bottom-40">
				<div class="page-header">
					<h1 class="text-uppercase">Shipping Policy</h1>
					<hr>
				</div>
			</div>
		</div>
		<div class="row">
			<div><br>
				...
				<p>
					Sellers incur relatively higher shipping costs on low value items. In such cases, charging a nominal delivery charge helps them offset logistics costs. The delivery charge may be waived off by some Sellers, if you shop with them for a minimum predefined value.<br><br>
					For example, seller charges Rs 40 for delivery per item if the order value is less than Rs 500. While, orders of Rs 500 or above are delivered free. Please check with individual Sellers to understand their delivery charges.<br>
				</p><br>
				<h3>
				...
				<p><br></p>
				<p>Estimated delivery time depends on the following factors:<br>
				</p>
				<ul>
				...
				<p><br></p>
				<h3>
					Are there any hidden costs (sales tax, octroi etc) on items sold by Sellers on Boot?
				</h3>
				<p>There are NO hidden charges when you make a purchase on Boot. List prices are final and all-inclusive. The price you see on the product page is exactly what you would pay.
				</p><br>
				<p>
				...
				<p>Please enter your default pin code on the product page (you don't have to enter it every single time) to know more accurate delivery times on the product page itself.
				</p><br>
				<h3>
				...
				<p>Whether your location can be serviced or not depends on
				</p>
				<ul>
				...
				<p>Our courier partners have limits on the cash amount payable on delivery depending on the destination and your order value might have exceeded this limit. Please enter your pin code on the product page to check if CoD is available in your location.
				</p><br>
				<h3>
				...
				<p>Wherever possible Ekart Logistics will facilitate the pick-up of the item. In case, the pick-up cannot be arranged through Ekart, you can return the item through a third-party courier service. Return fees are borne by the Seller.
				</p><br>
				<h3>
				...
				<p>
					...
					FFor items listed as "In Stock", Sellers will mention the delivery time based on your location pincode (usually 2-3 business days, 4-5 business days or 4-6 business days in areas where standard courier service is available).  
					For other areas, orders will be sent by Registered Post through the Indian Postal Service which may take 1-2 weeks depending on the location.<br><br>
					<b>
						'Available'
					</b><br>
				...
				<h3>
					Does Boot deliver internationally?
				</h3>
				<p>
					As of now, Boot doesn't deliver items internationally.<br><br>
					You will be able to make your purchases on 
					our site from anywhere in the world with credit/debit cards issued in India and 21 other countries, but 
					please ensure the delivery address is in India.
				</p><br>
			</div>
		</div>
	</div>
