      ...
      <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                  <li style="padding: 70px 0 0;">
                        <a href="{{ route('seller.home')  }}" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                                                                       aria-hidden="true"></i>Dashboard</a>
                  </li>
                  <li>
                        <a href="/seller/addproduct" class="waves-effect"><i class="fa fa-cube fa-fw"
                                                                                      aria-hidden="true"></i>Add Product</a>
                  </li>
                  <li>
                        <a href="/seller/addSKU" class="waves-effect"><i class="fa fa-cube fa-fw"
